...
- Available [here](http://minimaxir.com/csv/buzzfeed_linkbait_headlines.csv).
...
- I've got a nice little function that acts like a theme for a ggplot graph. You can get it [here](https://paste.ubuntu.com/15234610/).
